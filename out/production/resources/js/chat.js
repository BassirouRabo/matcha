...
function onMessage(msg)
{
    ...
    if (messages[0] === MSG_CHAT && messages.length === 4) {
        ...
        onlines.push(messages[1]);
        out = '<div class="suggestion-usd"><a href="/'+ messages[1] +'"><img src="'+ messages[3] +'" width="35px" height="35px" alt=""></a> <div class="sgt-text"><h4>'+ messages[1] + '</h4></div> <span> <a href = "/' + messages[1] + '"><i class="la la-user"></i></a></span></div>';
